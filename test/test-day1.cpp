...
TEST(aoc24_example_input, day1) {
    // Data pre-processing
    auto data = read_delim_file("test_data/day1_example.txt", true); // TODO: need to learn how to handle paths/args passed into gtests
...
//     // Data pre-processing
//     auto data = read_delim_file("test_data/day1_example.txt", true);
//     const size_t n_rows = data.size();
